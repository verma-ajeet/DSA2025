...
//		Odd even
	...
	private void sort01() {
		...
		Node zeroTail = zeroDummmy;
		Node oneTail = oneDummmy;
		Node twoTail = twoDummmy;
		Node curr = head;
		while (curr != null) {
			if (curr.data == 0) {
				zeroTail.next = curr;
		...
		zeroTail.next = (oneDummmy.next != null) ? oneDummmy.next : twoDummmy.next;
		oneTail.next = twoDummmy.next;
		twoTail.next = null;
		head = zeroDummmy.next;
		System.out.println("After sorting 0 1 2");
	}
