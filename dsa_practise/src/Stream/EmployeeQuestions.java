...
public class EmployeeQuestions {
	public static void main(String[] args) {
		...
		Map<String, Long> noOfFemaleAndMale = employeeList.stream()
				.collect(Collectors.groupingBy(Employee::getGender, Collectors.counting()));
		System.out.println(noOfFemaleAndMale);
		Map<String, Double> avgSalaryOnGender = employeeList.stream()
				.collect(Collectors.groupingBy(Employee::getGender, Collectors.averagingDouble(Employee::getSalary)));
		System.out.println(avgSalaryOnGender);
